 ...
 */
function showdownCustomClass(): Mmmark.ShowdownExtension[] {
  return [
    {
      type: "output",
      filter: (text) => {
...
Mmmark.registerExtension("showdownCustomClass", showdownCustomClass());

export default showdownCustomClass;
