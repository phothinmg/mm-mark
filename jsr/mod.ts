...
namespace Mmmark {
  ...
  export type ShowdownConverterOptions = Showdown.ConverterOptions;
  export type EventListener = Showdown.EventListener;
  export type ShowdownExtension = Showdown.ShowdownExtension;
  export type ShowdownConverterExtensions = Showdown.ConverterExtensions;
  ...
  /**
   * This interface is Showdown.ConverterOptions
   */
  ...
  interface ConverterOptions extends MmmarkOptions {
    /**
  ...
  export type Converter = Showdown.Converter;
  ...
  export const getAllOptions = (
    ...
    const dfoptions: ShowdownConverterOptions = {
      /**
  ...
  class MarkdownConverter<T> {
    ...
    private firstOpts: ShowdownConverterOptions;
 ...
 */
  ...
  export function validateExtension(
    ext: Showdown.ShowdownExtension[] | Showdown.ShowdownExtension
  ): boolean {
   ...
   */
  export function registerExtension(name: string, ext: Extension): void {
   ...
   * @throws Throws if `name` is not of type string.
   */
  export function registerSubParser(name: string, func: Showdown.SubParser): void {
