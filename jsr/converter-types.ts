...
export interface EventListener {
	...
	(
		...
		text: string,
		converter: Converter,
		options: ShowdownConvertOptions,
...
interface RegexReplaceExtension extends Extension {
	 ...
	 */
	replace?: string | string[] | RegExp | RegExp[] // string | Replace
}
...
export type ShowdownExtension = RegexReplaceExtension & FilterExtension
...
export type ShowdownConverterExtensions = {
	language: ShowdownExtension[]
	output: ShowdownExtension[]
}
export type MmExtension =
...
export type Converter = {
	 ...
	 */
	setOption(key: string, value: CustomOptions): void
	 ...
	 */
	getOption(key: string): CustomOptions
	 ...
	 */
	getOptions(): ShowdownConvertOptions
...
type CustomOptions =
	...
	>
	| number
export interface ConverterOptions extends MmmarkOptions {
	/**
...
export interface ShowdownConvertOptions extends ConverterOptions {
	/**
 ...
 * Showdown subParser.
 */
export type SubParser = (...args: Array<string | RegExp>) => string
